...
class NetworkManager {
    ...
    func perform(localNumbersWithcompletion completion: @escaping NetworkTaskCompletion) {
        let data = loadLocalStub(fileName: "numbers", fileExtension: "json")
        completion(.success(result: data))
    }
